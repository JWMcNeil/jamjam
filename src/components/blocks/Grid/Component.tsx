...
import type { ContentCardBlock, ContentBlock } from '@/payload-types'

import { ContentBlock as ContentBlockComponent } from '@/components/blocks/Content/Component'
import { ContentCardBlock as ContentCardBlockComponent } from '@/components/blocks/ContentCard/Component'

type GridBlockProps = {
  columns?: '2' | '3' | '4' | null
  contentCards?: (ContentCardBlock | ContentBlock)[] | null
}
