...
import * as migration_20260415_084851_add_lab_collection_versions from './20260415_084851_add_lab_collection_versions';
...
export const migrations = [
  ...
  {
    up: migration_20260415_084851_add_lab_collection_versions.up,
    down: migration_20260415_084851_add_lab_collection_versions.down,
    name: '20260415_084851_add_lab_collection_versions',
  },
];
